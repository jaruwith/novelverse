...
export function MobileNavigation({close}:{close:()=>void}){return <div className={styles.drawer}><button className="textButton" onClick={close}>✕ ปิดเมนู</button><Link href="/">หน้าแรก</Link><Link href="/creator/dashboard">พื้นที่ครีเอเตอร์</Link><Link href="/login">เข้าสู่ระบบ</Link></div>}
